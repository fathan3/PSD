...
Setelah masing-masing parameter polutan dibersihkan, kita menggabungkan seluruh tabel (NO₂, SO₂, O₃, CO) menjadi satu buah file CSV yang terpadu bernama `Data_Polutan_Kota-Warudoyong.csv`. File ini yang nantinya siap masuk ke tahap pemodelan (*Modeling*).
